...
tags: ["query:robot"]
score: 7.0
evidence: 移动机器人的主动感知与决策规划
tldr: 针对移动机器人主动感知中计算效率与路径质量的权衡问题，本文提出了一种高效的节点级束搜索（NBS）算法。该算法通过在每个节点保留前B个候选路径来优化搜索空间，并引入了结合前沿信息的期望增益指标以平衡探索与利用。此外，提出RRAG图构建方法以增强环境适应性。实验表明，该方法在多项任务中优于现有SOTA算法，并在真实机器人上得到了验证。
selection_source: fresh_fetch
motivation: 现有的主动感知方法在计算效率和路径约束之间难以平衡，且标准束搜索算法容易陷入局部最优并对参数敏感。
method: 提出了节点级束搜索（NBS）算法，结合了基于前沿的期望增益指标，并利用快速探索随机环形图（RRAG）进行环境建模。
result: "实验证明NBS结合RRAG在多项主动感知任务中表现优异，相比现有最先进算法在特定任务中性能提升了至少20%。"
conclusion: 该研究提供了一种高效且可扩展的主动感知框架，通过改进搜索策略和图构建方法，显著提升了机器人在复杂环境下的信息获取能力。
---
